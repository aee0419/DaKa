            ...
            <div class="info-center">
                ...
                <?php echo form_open('edu/doadd'); ?>
                    <div class="form-group">
                        <label  class="col-sm-2 control-label">新学历</label>
                        <div class="col-sm-10">
                            <?php echo form_input('eduname','',['class'=>'form-control']) ?>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                             <?php echo form_submit('submit','添加学历',['class'=>'btn btn-primary form-control']) ?>
                        </div>
                    </div>
