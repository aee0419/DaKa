            ...
            <div class="info-center">
                ...
                <div class="form-horizontal" style="width: 50%;margin: 50px;text-align: center">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="密码" value="123" required="required" name="password">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="edu" class="form-control">
                                ...
                                if(is_array($edu)):
                                    foreach($edu as $v):
                                        ?>
                                        <option value="<?php echo $v->id;?>"><?php echo $v->eduname;?></option>
                                        <?php
                                    endforeach;
                                endif;
                                ?>
                        ...
                        <div class="col-sm-10">
                            <select name="pos" class="form-control">
                                ...
                                if(is_array($pos)):
                                    foreach($pos as $v):
                                        ?>
                                        <option value="<?php echo $v->id;?>"><?php echo $v->posname;?></option>
                                        <?php
                                    endforeach;
                                endif;
                                ?>
                        ...
                        <div class="col-sm-10">
                            <select name="dep" class="form-control">
                                ...
                                if(is_array($dep)):
                                    foreach($dep as $v):
                                        ?>
                                        <option value="<?php echo $v->id;?>"><?php echo $v->depname;?></option>
                                        <?php
                                    endforeach;
                                endif;
                                ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" name="submit" class="btn btn-primary btn-block">添加</button>
                        </div>
                    </div>
                </div>
                </form>
